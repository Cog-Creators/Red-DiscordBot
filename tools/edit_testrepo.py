...
edit_testrepo.py export:
    It exports repo from provided directory into ``tests/core/_downloader/downloader_testrepo.export``
...
TEST_REPO_EXPORT_PTH: Path = (
    MAIN_DIRECTORY / "tests" / "core" / "_downloader" / "downloader_testrepo.export"
)
