...
def createEmptyFiles():
	...
	games = ["Multi Theft Auto", "her Turn()", "Tomb Raider II", "some music.", "Audiosurf", "some groovy music.", "some heavy metal.", "some funky music.", "DayZ", "NEO Scavenger", "Python", "World Domination", "Line Rider", "with your heart.", "Space Engineers.", "Medieval Engineers", "Unreal Tournmament", "GTA VI", "Patience", "Poker.", "Star Wars Battlefront", "World of Warcraft", "Pacman", "Call of Duty 4: Modern Warfare", "Mens erger je niet!", "Sonic & All-Starts Racing Transformed", "Minecraft", "Counter Strike Global Offensive", "Unreal Tournament 2004", "Counter Strike 1.6", "Duck Hunt", "Star Fox", "Duke Nukem 3D", "Bomberman", "Super Mario", "Battlefield 2: Modern Combat", "Barricade", "Donkey Kong", "Revolt", "Pong", "Rayman", "Raymen Legents", "Rollercoaster Tycoon", "Guitar", "Autobahn Racer", "Command & Conquer Red Alert", "Worms", "Flight Simulator", "Prince of Persia", "Mijnenveger", "FIFA International Soccer", "Besiege", "Portal 2", "FIFA: Road to World Cup 98", "Banjo", "Terraria", "Mario Kart", "Robocraft", "Rust", "Dungeonland", "Chivalry: Medieval Warfare", "HAWKEN", "Battlefield: Bad Company 2", "OpenTTD", "Arma III", "Tetris", "Need For Speed: Underground", "Kerbal Space Program","SimCity 2000", "Sjoelen", "Star Wars-The Old Republic", "Garry's Mod", "Colin McRae: DiRT", "SuperTuxKart", "Twister"]
