...
#. ``[p]bankset`` is now a core command and as a consequence, bank cog has been removed. This means that when you start the bot for the first time after the update, you'll see "Failed to load package bank" message. That is perfectly normal and this message can be ignored.
