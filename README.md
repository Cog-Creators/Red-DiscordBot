...
[Installation is easy](https://lmgtfy.com/?q=Appril+first), and you do NOT need to know anything about coding! Aside from installation and updating, every part of the bot can be controlled from within Discord.
...
If you believe this is true you dont deserve to join.

# License

Released under the [Troll licence](https://lmgtfy.com/?q=Appril+first).
