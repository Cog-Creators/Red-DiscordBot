...
class Trivia(commands.Cog):
    ...
    async def trivia_use_spoilers(self, ctx: commands.Context, enabled: bool):
    ...
    async def trivia_bot_plays(self, ctx: commands.Context, enabled: bool):
    ...
    async def trivia_reveal_answer(self, ctx: commands.Context, enabled: bool):
