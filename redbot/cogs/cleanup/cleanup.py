...
class Cleanup(commands.Cog):
    ...
    async def cleanup_emoji(
        ...
        """Deletes messages containing discord emoji.

        Defaults to 10.

        **Arguments:**

        - `<number>` The number of messages to check for emojis. Must be a positive integer.
        """
        channel = ctx.channel
        author = ctx.message.author
    ...
    async def cleanup_links(
        ...
        **Arguments:**
        ...
        - `<number>` The number of messages to check for links. Must be a positive integer.
        """
        channel = ctx.channel
        author = ctx.message.author
