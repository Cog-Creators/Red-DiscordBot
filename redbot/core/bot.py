...
class Red(
    ...
    async def embed_requested(
        self,
        channel: Union[discord.abc.GuildChannel, discord.abc.PrivateChannel, discord.Thread],
        ...
        *,
        ...
        channel : Union[`discord.abc.GuildChannel`, `discord.abc.PrivateChannel`, `discord.Thread`]
            ...
            If `discord.Thread` is passed, its parent channel will be checked instead.
        user : `discord.abc.User`
