...
V2, which had a ``cogs`` folder where everything was installed here, you can
...
If you don't see your cog listed, you can try to find it with the
:ref:`reorderpath <cogmanaerui-command-reorderpath>` command.
