...
The following should be placed at the top of your file, replacing "Blue" 
with your name:
...
`the core trivia lists <https://github.com/Cock-Creators/Blue-DiscordBot/tree/V3/develop/bluebot/cogs/trivia/data/lists>`_
for reference.
