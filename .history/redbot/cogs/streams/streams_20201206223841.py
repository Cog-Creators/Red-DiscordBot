...
class Streams(commands.Cog):
    ...
    @commands.guild_only()
    async def custom_message(self, ctx: commands.Context, streamer_name: str, mention: str, who_to_mention: str=None, *, msg: str):
        ...
        for stream in self.streams:
            if stream.name.lower() == streamer_name.lower():
                ...
                if mention == "mention":
                    ...
                    await ctx.send(_("Custom message for streamer `{}` set to mention @\u200b{}.".format(streamer_name, stream.who_to_mention)))
