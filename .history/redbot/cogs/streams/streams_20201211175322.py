                    ...
                    for channel_id in stream.channels:
                        ...
                        if mention_str:
                            ...
                            if stream.id in self.streamer_info:
                                ...
                                if hasattr(self.[stream.id], "mention_message"):
                                    content = _("{mention}, {mention_message}".format(
                                        mention = self.streamer_info[stream.id].who_to_mention,
                                        mention_message = self.streamer_info[stream.id].mention_message))
                            elif alert_msg:
